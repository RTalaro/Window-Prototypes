...
@onready var windows: Array[Node] = get_children()
...
@onready var Windows11_dark = load("res://Themes/Windows11/Windows11_Dark.tres")
@onready var Windows11_light = load("res://Themes/Windows11/Windows11_Light.tres")
@onready var Windows95 = load("res://Themes/Windows95/Windows95.tres")
@onready var Windows98 = load("res://Themes/Windows98/theme.tres")
@onready var Windows10_dark = load("res://Themes/Windows10_Dark/Windows10_Dark.tres")
@onready var Windows10_light = load("res://Themes/Windows10_Light/Windows10_Light.tres")
@onready var controlsDialog = preload("res://Themes/TestDialog.tscn")

func _ready():
	# set sample window theme
	theme = Windows10_light
	# add example window
